...
public class gameWindow implements ActionListener{
    ...
    void init() throws IOException{
        ...
        coinmage = ImageIO.read(this.getClass().getResource("world\\coin.gif"));
        coin = new Sprite(PipeX,320,25,35,0,coinmage,"Coin",true);
        pipeup = ImageIO.read(this.getClass().getResource("world\\pipeup.gif"));
        pipedown = ImageIO.read(this.getClass().getResource("world\\pipedown.gif"));
        mainworld = ImageIO.read(this.getClass().getResource("world\\birdplay.gif"));
        startt = ImageIO.read(this.getClass().getResource("world\\flappybirdstart.gif"));
        deathh = ImageIO.read(this.getClass().getResource("world\\death.gif"));
