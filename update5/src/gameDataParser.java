...
public class gameDataParser {
    ...
    String[] steitems = {"2 coins per 1","3 coins per 1","Decreased coin spread","Pipe X distance increase","Pipe Y distance increase","Green bird","Blue bird"};
    int[] steitemsval = {150,250,400,300,900,400,400};
    ...
    "Get a blue bird as an option!"};
    int[] levelreq = {10,20,40,30,60,30,30};
    //file values
    int highScore = 0;
    int coins = 0;
