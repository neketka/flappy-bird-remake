...
public class gameDataParser {
    ...
    String[] steitems = {"2 coins per 1","3 coins per 1","Decreased coin spread","Pipe X distance increase","Pipe Y distance increase"};
    int[] steitemsval = {150,250,400,300,900};
